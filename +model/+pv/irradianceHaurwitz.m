function clearSkyGHI = irradianceHaurwitz(apparentZenithAngle)
...
p.parse(apparentZenithAngle);

% Haurwitz uses 94.4 cal/cm^2/hr, this converts to approximately 1098 W/m^2
clearSkyGHI = 1098.* cosd(apparentZenithAngle) .* exp(-0.059 ./ cosd(apparentZenithAngle));
