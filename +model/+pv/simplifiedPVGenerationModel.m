function netPVSystemPower = simplifiedPVGenerationModel( time, location, inverterRating, varargin )

%% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%% NOTE: When validating model, ensure updated solar constant is used
...
EOT = 9.9*sind(2*eclipticLongitude) - 7.1*cosd(eclipticLongitude) - 1.9*sind(eclipticLongitude) - 0.4*cosd(2*eclipticLongitude);
...
sampleOffset = (timeValues(2) - timeValues(1)) * MINUTES_IN_DAY / 2;
