...
% date2doy Determine day of year from year, month of year, and day of month
%
% Syntax
...
%           could be 12.5); if fractional, date2doy will maintain the fractional day.
%
...
%   date2doy(2012, 4, 31) = date2doy(2012, 5, 1). 
%
% See also leapyear PVL_DOY2DATE DATEVEC
