function [DNI, Kt] = irradianceDirectDISC(GHI,Z, doy, varargin)
% IRRADIANCE_DIRECT_DISC Estimate Direct Normal Irradiance from Global Horizontal Irradiance using the DISC model
%
% Syntax
% [DNI, Kt] = irradianceDirectDisc(GHI,Z, doy)
% [DNI, Kt] = irradianceDirectDisc(GHI,Z, doy, pressure)
