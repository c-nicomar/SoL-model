function [Result] = modelSingleDiode(IL, I0, Rs, Rsh, nNsVth, varargin)
% MODEL_SINGLE_DIODE Solve the single-diode model to obtain a photovoltaic IV curve
%
% Syntax
...
function [I]=I_from_V(Rsh, Rs, nNsVth, V, Io, Iphi)
	...
	argW = Rs.*Io.*Rsh.*...
		...
		(nNsVth.*(Rs + Rsh));
	inputterm = model.pv.wapr_vec(argW);
