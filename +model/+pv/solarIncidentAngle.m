function AOI = solarIncidentAngle(SurfTilt, SurfAz, SunZen, SunAz)
% solarIncidentAngle Determine angle of incidence from surface tilt/azimuth and apparent sun zenith/azimuth 
%
% Syntax
%   AOI = solarIncidentAngle(surftilt, surfaz, sunzen, sunaz)
%   
% Description
