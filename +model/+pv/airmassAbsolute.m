function AMa = airmassAbsolute(AMrelative,pressure)
% airmassAbsolute Determine absolute (pressure corrected) airmass from relative airmass and pressure
%
% Syntax
% AMa = airmassAbsolute(AMrelative, pressure)
%
% Description
% 
