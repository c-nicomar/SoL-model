function Press=alt2pres(altitude)
% alt2pres Determine site pressure from altitude
%
% Syntax
%   Press = alt2pres(altitude)
% 
% Description
%   alt2pres determines the atmospheric pressure (in Pascals) of a 
