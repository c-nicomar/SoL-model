function GR = irradianceGroundDiffuse(SurfTilt, GHI, Albedo)
% IRRADIANCE_GROUND_DIFFUSE Estimate diffuse irradiance from ground reflections given irradiance, albedo, and surface tilt 
%
% Syntax
%   GR = irradianceGroundDiffuse(SurfTilt, GHI, Albedo)
%
% Description
